...
class ObservationsCfg:
    ...
    class CriticCfg(ObsGroup):
        ...
        command = ObsTerm(func=mdp.generated_commands, params={"command_name": "twist"})
        joint_pos_slot01 = ObsTerm(
            func=mdp.joint_pos_rel, params={"asset_cfg": _slot_cfg(SLOT_0_1)}, scale=1.0
        )
        joint_pos_slot23 = ObsTerm(
            func=mdp.joint_pos_rel, params={"asset_cfg": _slot_cfg(SLOT_2_3)}, scale=1.0
        )
        joint_pos_slot45 = ObsTerm(
            func=mdp.joint_pos_rel, params={"asset_cfg": _slot_cfg(SLOT_4_5)}, scale=1.0
        )
        joint_vel_slot01 = ObsTerm(
            func=mdp.joint_vel_rel, params={"asset_cfg": _slot_cfg(SLOT_0_1)}, scale=1.0
        )
        joint_vel_slot23 = ObsTerm(
            func=mdp.joint_vel_rel, params={"asset_cfg": _slot_cfg(SLOT_2_3)}, scale=1.0
        )
        joint_vel_slot45 = ObsTerm(
            func=mdp.joint_vel_rel, params={"asset_cfg": _slot_cfg(SLOT_4_5)}, scale=1.0
        )
        actions = ObsTerm(func=mdp.last_action)
        base_lin_vel = ObsTerm(func=mdp.base_lin_vel)
        foot_height = ObsTerm(func=mdp.foot_height, params={"asset_cfg": _feet_cfg()})
        foot_air_time = ObsTerm(
            func=mdp.foot_air_time, params={"sensor_name": "feet_contact"}
        )
        foot_contact = ObsTerm(
            func=mdp.foot_contact, params={"sensor_name": "feet_contact"}
        )
        foot_contact_forces = ObsTerm(
            func=mdp.foot_contact_forces, params={"sensor_name": "feet_contact"}
        )
